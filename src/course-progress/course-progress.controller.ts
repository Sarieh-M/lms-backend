...
export class CourseProgressController {
  ...
  async markLectureAsViewed(@Body() markLectureDto: CreateCourseProgressDto,@CurrentUser() userPayload: JWTPayloadType,
  ) {
    return this.courseProgressService.markLectureAsViewed(markLectureDto,userPayload,);
  }
  ...
  async getCurrentCourseProgress(
    ...
    return this.courseProgressService.getCurrentCourseProgress(new Types.ObjectId(idCourse), currentUser, page, limit);
  }
  ...
  async resetCurrentCourseProgress(@Param('idCourse') idCourse: string,@CurrentUser() currentUser: JWTPayloadType,
  ) {
